...
import { GiInjustice, GiPaperBagCrumpled } from 'react-icons/gi';
...
import TabContentCost from '@organisms/tab-content-project-cost';
...
const TabProjectPhysicalNFT: React.FC<any> = () => {
				...
				>
					...
					<Tab
						label={
							<span className="flex items-center">
								<span>
									<GiPaperBagCrumpled className="text-3xl" />
								</span>{' '}
...
export default React.memo(TabProjectPhysicalNFT);
