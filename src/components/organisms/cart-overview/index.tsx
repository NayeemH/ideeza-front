...
export default function CartOverviewHome(props: any) {
	const { setCartPage } = props;
	...
	return (
        ...
        <CartStepper currentStep={0} />
			...
			<div className="bg-white shadow rounded-lg p-7">
              ...
              classes={{
                root: `text-white bg-current border border-solid border-current tracking-tight font-sans capitalize p-2 px-4 text-base 2xl:text-xl`,
              }}
            //   onClick={() => {
