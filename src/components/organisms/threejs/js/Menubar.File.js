...
function MenubarFile(editor) {
  ...
  option = new UIRow();
  option.setClass('option');
  option.setTextContent(strings.getKey('menubar/file/export/svg'));
  option.onClick(async function () {
    // var { SVGRenderer } = await import(
    ...
    // rendererSVG.setSize(canvas.clientWidth, canvas.clientHeight);
    // rendererSVG.render(editor.scene, editor.viewportCamera);
    // // rendererSVG.overdraw = 1;
    // console.log(rendererSVG);
