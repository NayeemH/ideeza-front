...
function GeometryParametersPanel(editor, object) {
  ...
  innerRadiusRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/ring_geometry/innerRadius')
    ).setWidth('90px')
  );
  ...
  outerRadiusRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/ring_geometry/outerRadius')
    ).setWidth('90px')
  );
  ...
  thetaSegmentsRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/ring_geometry/thetaSegments')
    ).setWidth('90px')
  );
  ...
  phiSegmentsRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/ring_geometry/phiSegments')
    ).setWidth('90px')
  );
  ...
  thetaStartRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/ring_geometry/thetastart')
    ).setWidth('90px')
  );
  ...
  thetaLengthRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/ring_geometry/thetalength')
    ).setWidth('90px')
  );
