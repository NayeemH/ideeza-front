...
function SidebarScene(editor) {
  ...
  var backgroundTexture = new UITexture()
    .setMarginLeft('8px')
    .onChange(onBackgroundChanged);
  backgroundTexture.setDisplay('none');
  backgroundRow.add(backgroundTexture);

  var backgroundEquirectangularTexture = new UITexture()
    .setMarginLeft('8px')
    .onChange(onBackgroundChanged);
  ...
  var environmentEquirectangularTexture = new UITexture()
    .setMarginLeft('8px')
  ...
  function refreshUI() {
    ...
    (function addObjects(objects, pad) {
      for (var i = 0, l = objects.length; i < l; i++) {
        ...
        if (option.textContent.trim() !== 'polygonBackground') {
          options.push(option);
        }
