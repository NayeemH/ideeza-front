...
function GeometryParametersPanel(editor, object) {
  ...
  radiusTopRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/cylinder_geometry/radiustop')
    ).setWidth('90px')
  );
  ...
  radiusBottomRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/cylinder_geometry/radiusbottom')
    ).setWidth('90px')
  );
  ...
  radialSegmentsRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/cylinder_geometry/radialsegments')
    ).setWidth('90px')
  );
  ...
  heightSegmentsRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/cylinder_geometry/heightsegments')
    ).setWidth('90px')
  );
  ...
  openEndedRow.add(
    new UIText(
      strings.getKey('sidebar/geometry/cylinder_geometry/openended')
    ).setWidth('90px')
  );
