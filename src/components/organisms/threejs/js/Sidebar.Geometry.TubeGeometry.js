...
function GeometryParametersPanel(editor, object) {
  ...
  var tubularSegments = new UIInteger(parameters.tubularSegments).onChange(
    update
  );
  ...
  var radialSegments = new UIInteger(parameters.radialSegments).onChange(
    update
  );
  ...
  var tensionRow = new UIRow().setDisplay(
