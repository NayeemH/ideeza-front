...
const ElectronicsSidebar = (props: any) => {
	...
	const getCategories = async (page = 1, pageSize = 100) => {
		const params = `?category_type=ELECTRONIC&page=${page}&page_size=${pageSize}${
	...
	return (
		<div>
			...
			{/* <div
				onClick={ () => {
					dispatch(setOpenBlockMenu('psb child'))
				}}
			>
				onClickOpen Psb Block Menu
			</div> */}
			<div
