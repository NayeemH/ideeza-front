...
export default function FormCustomBlock({ setFormStep, methods, setFormback }: IProps) {
	const {
		register,
		handleSubmit,
		formState: { errors },
			...
			>
				<div className="flex flex-col items-center border-b py-2">
					{/* <div className="flex items-center w-full border-b pb-[20px]">
						<label className="text-[#666666] ">Input Type</label>
						<select
							{...register('type')}
							className="form-select border pl-3 rounded-none border-gray-725 w-full text-[#7A7A7A] font-sans"
						>
					...
					{/* <div className="flex items-center w-full border-b pb-[20px]">
						<label className="text-[#666666]">Input Pin</label>
						<div>
							<input
								type="number"
					...
					<div className="flex items-center justify-between w-full border-b pb-[20px]">
						<Label
							value="Value Input"
						...
						<input
							type="checkbox"
							{...register('add_input_1', { required: false })}
					...
					{/* <div className="flex items-center w-full border-b pb-[20px]">
						<label className="text-[#666666] tracking-tight text-base 2xl:text-xl font-proxima-nova whitespace-nowrap mr-[20px] w-[42%]">Input Variable Value</label>
						<div>
							<input
								type="number"
								className="form-input"
					...
					<div className="flex items-center justify-between w-full border-b py-[20px]">
						<Label
					...
					<div className="flex items-center w-full border-b pb-[20px]">
						...
						<div className="w-full">
							<input
								type="text"
								className="pl-[20px] py-[15px] border border-solid rounded-[6px] border-[#E6E6E6] bg-[#FBFBFB] w-[100%] outline-none placeholder-[#B9B9B9] text-[16px] font-proxima-nova"
								placeholder="Input 2 Variable Name"
								{...register('append_value_input_name', {
									// required: 'Enter input 2 variable name',
									// maxLength: 255,
									required: false,
								})}
							/>
					...
					{/* <div className="grid grid-cols-2 py-2 w-full gap-1">
						<Label
				...
				<div className="flex items-center justify-between w-full pt-6 2xl:px-16 lg:px-3 md:px-0">
					<Button
						onClick={setFormback}
						value="Back"
						type="button"
