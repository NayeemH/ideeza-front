			...
			defs: {
				...
				THREE: {
					...
					OrthographicCamera: {
						...
						'!type':
							'fn(left: number, right: number, top: number, bottom: number, near: number, far: number)',
					},
					PerspectiveCamera: {
						...
						prototype: {
							...
							setViewOffset: {
								'!type':
									'fn(fullWidth: number, fullHeight: number, x: number, y: number, width: number, height: number)',
					...
					Face3: {
						...
						'!doc': 'Triangle face.',
						'!type':
							'fn(a: number, b: number, c: number, normal: +THREE.Vector3, color: +THREE.Color, materialIndex: number)',
					},
					Geometry: {
						...
						prototype: {
							...
							merge: {
								'!type':
									'fn(geometry: +THREE.Geometry, matrix: +THREE.Matrix4, materialIndexOffset: number)',
					...
					Raycaster: {
						...
						'!type':
							'fn(origin: +THREE.Vector3, direction: +THREE.Vector3, near: number, far: number)',
					},
					Lut: {
					...
					FontUtils: {
						...
						prototype: {
							...
							extractGlyphPoints: {
								'!type':
									'fn(c: string, face: string, scale: number, offset: number, path: +THREE.Path) -> object',
					...
					Path: {
						...
						prototype: {
							...
							arc: {
								'!type':
									'fn(aX, aY, aRadius, aStartAngle, aEndAngle, aClockwise) -> todo',
								'!doc': 'todo',
							},
							absarc: {
								'!type':
							...
							ellipse: {
								'!type':
									'fn(aX, aY, xRadius, yRadius, aStartAngle, aEndAngle, aClockwise) -> todo',
								'!doc': 'todo',
							},
							absellipse: {
								'!type':
					...
					CubicBezierCurve3: {
						...
						'!type':
							'fn(v0: +THREE.Vector3, v1: +THREE.Vector3, v2: +THREE.Vector3, v3: +THREE.Vector3)',
					},
					EllipseCurve: {
						...
						'!type':
							'fn(aX: number, aY: number, xRadius: number, yRadius: number, aStartAngle: Radians, aEndAngle: Radians, aClockwise: bool)',
					},
					LineCurve: {
					...
					BoxGeometry: {
						...
						'!type':
							'fn(width: number, height: number, depth: number, widthSegments: number, heightSegments: number, depthSegments: number)',
					},
					CircleGeometry: {
						...
						'!type':
							'fn(radius: number, segments: number, thetaStart: number, thetaLength: number)',
					},
					CubeGeometry: {
					...
					CylinderGeometry: {
						...
						'!type':
							'fn(radiusTop: number, radiusBottom: number, height: number, radiusSegments: number, heightSegments: number, openEnded: bool, thetaStart: number, thetaLength: number)',
					},
					...
					LatheGeometry: {
						...
						'!type':
							'fn(points: [], segments: number, phiStart: number, phiLength: number)',
					},
					OctahedronGeometry: {
					...
					PlaneGeometry: {
						...
						'!type':
							'fn(width: number, height: number, widthSegments: number, heightSegments: number)',
					},
					PolyhedronGeometry: {
					...
					RingGeometry: {
						...
						'!type':
							'fn(innerRadius: number, outerRadius: number, thetaSegments: number, phiSegments: number, thetaStart: number, thetaLength: number)',
					},
					ShapeGeometry: {
					...
					SphereGeometry: {
						...
						'!type':
							'fn(radius: number, widthSegments: number, heightSegments: number, phiStart: number, phiLength: number, thetaStart: number, thetaLength: number)',
					},
					TetrahedronGeometry: {
					...
					TorusGeometry: {
						...
						'!type':
							'fn(radius: number, tube: number, radialSegments: number, tubularSegments: number, arc: number)',
					},
					TorusKnotGeometry: {
						...
						'!type':
							'fn(radius: number, tube: number, radialSegments: number, tubularSegments: number, p: number, q: number, heightScale: number)',
					},
					TubeGeometry: {
						...
						'!type':
							'fn(path: +THREE.Curve, segments: number, radius: number, radiusSegments: number, closed: bool)',
					},
					ArrowHelper: {
						...
						prototype: {
							...
							setLength: {
								'!type':
									'fn(length: number, headLength: number, headWidth: number)',
						...
						'!type':
							'fn(dir: +THREE.Vector3, origin: +THREE.Vector3, length: number, hex: number, headLength: number, headWidth: number)',
					},
					AxisHelper: {
					...
					EdgesHelper: {
						...
						'!type':
							'fn(object: +THREE.Object3D, color: +THREE.Color, thresholdAngle: number)',
					},
					FaceNormalsHelper: {
						...
						'!type':
							'fn(object: +THREE.Object3D, size: number, color: +THREE.Color, linewidth: number)',
					},
					GridHelper: {
					...
					HemisphereLight: {
						...
						'!type':
							'fn(skyColorHex: number, groundColorHex: number, intensity: number)',
					},
					Light: {
					...
					SpotLight: {
						...
						'!type':
							'fn(hex: number, intensity: number, distance: todo, angle: todo, exponent: todo)',
					},
					BabylonLoader: {
						...
						prototype: {
							load: {
								'!type':
									'fn(url: string, onLoad: function, onProgress: function, onError: function)',
					...
					ColladaLoader: {
						...
						prototype: {
							...
							parse: {
								'!type':
									'fn(doc: Document, callBack: function, url: string) -> object',
							...
							applySkin: {
								'!type':
									'fn(geometry: +THREE.Geometry, instanceCtrl: object, frame: number)',
					...
					OBJMTLLoader: {
						...
						prototype: {
							load: {
								'!type':
									'fn(objUrl: string, mtlUrl: string, onLoad: function, onProgress: function, onError: function)',
								'!doc': 'Begin loading from urls and call onLoad with the parsed response content.',
							},
							parse: {
								'!type':
									'fn(text: string, mtllibCallback: function) -> +THREE.Object3D',
					...
					TGALoader: {
						...
						prototype: {
							load: {
								'!type':
									'fn(url: string, onLoad: function, onProgress: function, onError: function) -> +THREE.DataTexture',
					...
					SpriteCanvasMaterial: {
						...
						prototype: {
							...
							program: {
								'!type':
									'fn(context: CanvasRenderingContext2D, color: +THREE.Color)',
					...
					Box2: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(min: +THREE.Vector2, max: +THREE.Vector2) -> +THREE.Box2',
							...
							clampPoint: {
								'!type':
									'fn(point: +THREE.Vector2, optionalTarget: +THREE.Vector2) -> +THREE.Vector2',
							...
							setFromCenterAndSize: {
								'!type':
									'fn(center: +THREE.Vector2, size: +THREE.Vector2) -> +THREE.Box2',
					...
					Box3: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(min: +THREE.Vector3, max: +THREE.Vector3) -> +THREE.Box3',
							...
							clampPoint: {
								'!type':
									'fn(point: +THREE.Vector3, optionalTarget: +THREE.Vector3) -> +THREE.Vector3',
								'!doc': 'Clamps *point* within the bounds of this box.',
							},
							isIntersectionBox: {
							...
							setFromCenterAndSize: {
								'!type':
									'fn(center: +THREE.Vector3, size: +THREE.Vector3) -> +THREE.Box3',
								'!doc': "Centers this box on *center* and sets this box's width and height to the values specified\n\t\tin *size*.",
							},
						},
					...
					Color: {
						...
						prototype: {
							...
							addColors: {
								'!type':
									'fn(color1: +THREE.Color, color2: +THREE.Color) -> +THREE.Color',
					...
					Euler: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(x: number, y: number, z: number, order: string) -> +THREE.Euler',
							...
							setFromVector3: {
								'!type':
									'fn(vector: +THREE.Vector3, order: string) -> +THREE.Euler',
					...
					Frustum: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(p0: +THREE.Plane, p1: +THREE.Plane, p2: +THREE.Plane, p3: +THREE.Plane, p4: +THREE.Plane, p5: +THREE.Plane) -> bool',
						...
						'!type':
							'fn(p0: +THREE.Plane, p1: +THREE.Plane, p2: +THREE.Plane, p3: +THREE.Plane, p4: +THREE.Plane, p5: +THREE.Plane)',
					},
					Line3: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(start: +THREE.Vector3, end: +THREE.Vector3) -> +THREE.Line3',
							...
							closestPointToPoint: {
								'!type':
									'fn(point: +THREE.Vector3, clampToLine: bool, optionalTarget: +THREE.Vector3) -> +THREE.Vector3',
					...
					Math: {
						...
						prototype: {
							...
							mapLinear: {
								'!type':
									'fn(x: number, a1: number, a2: number, b1: number, b2: number) -> number',
					...
					Matrix3: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(n11: number, n12: number, n13: number, n21: number, n22: number, n23: number, n31: number, n32: number, n33: number) -> +THREE.Matrix3',
							...
							getInverse: {
								'!type':
									'fn(matrix4: +THREE.Matrix4, throwOnInvertible: bool) -> +THREE.Matrix3',
						...
						'!doc': 'A 3x3 matrix.',
						'!type':
							'fn(n11: number, n12: number, n13: number, n21: number, n22: number, n23: number, n31: number, n32: number, n33: number)',
					},
					Matrix4: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(n11: number, n12: number, n13: number, n14: number, n21: number, n22: number, n23: number, n24: number, n31: number, n32: number, n33: number, n34: number, n41: number, n42: number, n43: number, n44: number) -> +THREE.Matrix4',
							...
							makeBasis: {
								'!type':
									'fn(xAxis: +THREE.Vector3, zAxis: +THREE.Vector3, zAxis: +THREE.Vector3) -> +THREE.Matrix4',
							...
							lookAt: {
								'!type':
									'fn(eye: +THREE.Vector3, center: +THREE.Vector3, up: +THREE.Vector3) -> +THREE.Matrix4',
							...
							multiplyMatrices: {
								'!type':
									'fn(a: +THREE.Matrix4, b: +THREE.Matrix4) -> +THREE.Matrix4',
							...
							compose: {
								'!type':
									'fn(translation: +THREE.Vector3, quaternion: +THREE.Quaternion, scale: +THREE.Vector3) -> +THREE.Matrix4',
								'!doc': 'Sets this matrix to the transformation composed of *translation*, *quaternion* and *scale*.',
							},
							decompose: {
								'!type':
									'fn(translation: +THREE.Vector3, quaternion: +THREE.Quaternion, scale: +THREE.Vector3) -> []',
							...
							makeRotationAxis: {
								'!type':
									'fn(axis: +THREE.Vector3, theta: number) -> +THREE.Matrix4',
							...
							makePerspective: {
								'!type':
									'fn(left: number, right: number, top: number, bottom: number, near: number, far: number) -> +THREE.Matrix4',
						...
						'!doc': 'A 4x4 Matrix.',
						'!type':
							'fn(n11: number, n12: number, n13: number, n14: number, n21: number, n22: number, n23: number, n24: number, n31: number, n32: number, n33: number, n34: number, n41: number, n42: number, n43: number, n44: number)',
					},
					Plane: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(normal: +THREE.Vector3, constant: number) -> +THREE.Plane',
							...
							applyMatrix4: {
								'!type':
									'fn(matrix: +THREE.Matrix4, optionalNormalMatrix: +THREE.Matrix3) -> +THREE.Plane',
							...
							intersectLine: {
								'!type':
									'fn(line: +THREE.Line3, optionalTarget: +THREE.Vector3) -> +THREE.Vector3',
							...
							setFromNormalAndCoplanarPoint: {
								'!type':
									'fn(normal: +THREE.Vector3, point: +THREE.Vector3) -> +THREE.Vector3',
							...
							setComponents: {
								'!type':
									'fn(x: number, y: number, z: number, w: number) -> +THREE.Plane',
							...
							setFromCoplanarPoints: {
								'!type':
									'fn(a: +THREE.Vector3, b: +THREE.Vector3, c: +THREE.Vector3) -> +THREE.Plane',
					...
					Quaternion: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(x: number, y: number, z: number, w: number) -> +THREE.Quaternion',
							...
							setFromAxisAngle: {
								'!type':
									'fn(axis: +THREE.Vector3, angle: number) -> +THREE.Quaternion',
							...
							setFromUnitVectors: {
								'!type':
									'fn(vFrom: +THREE.Vector3, vTo: +THREE.Vector3) -> +THREE.Quaternion',
							...
							multiplyQuaternions: {
								'!type':
									'fn(a: +THREE.Quaternion, b: +THREE.Quaternion) -> +THREE.Quaternion',
							...
							multiplyVector3: {
								'!type':
									'fn(vector: +THREE.Vector3, dest: +THREE.Vector3) -> +THREE.Quaternion',
					...
					Ray: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(origin: +THREE.Vector3, direction: +THREE.Vector3) -> +THREE.Ray',
					...
					Sphere: {
						...
						prototype: {
							...
							setFromPoints: {
								'!type':
									'fn(points: [], optionalCenter: +THREE.Vector3) -> +THREE.Sphere',
					...
					Triangle: {
						...
						prototype: {
							...
							setFromPointsAndIndices: {
								'!type':
									'fn(points: [], i0: number, i1: number, i2: number) -> +THREE.Triangle',
								'!doc': "Sets the triangle's vectors to the vectors in the array.",
							},
							set: {
								'!type':
									'fn(a: +THREE.Vector3, b: +THREE.Vector3, c: +THREE.Vector3) -> +THREE.Triangle',
					...
					Vector2: {
						...
						prototype: {
							...
							addVectors: {
								'!type':
									'fn(a: +THREE.Vector2, b: +THREE.Vector2) -> +THREE.Vector2',
							...
							clamp: {
								'!type':
									'fn(min: +THREE.Vector2, max: +THREE.Vector2) -> +THREE.Vector2',
							...
							lerpVectors: {
								'!type':
									'fn(v1: +THREE.Vector2, v2: +THREE.Vector2, alpha: number) -> +THREE.Vector2',
					...
					Vector3: {
						...
						prototype: {
							...
							addVectors: {
								'!type':
									'fn(a: +THREE.Vector3, b: +THREE.Vector3) -> +THREE.Vector3',
								'!doc': 'Sets this vector to *a + b*.',
							},
							sub: {
								'!type': 'fn(v: +THREE.Vector3) -> +THREE.Vector3',
							...
							clamp: {
								'!type':
									'fn(min: +THREE.Vector3, max: +THREE.Vector3) -> +THREE.Vector3',
							...
							applyAxisAngle: {
								'!type':
									'fn(axis: +THREE.Vector3, angle: number) -> +THREE.Vector3',
							...
							lerpVectors: {
								'!type':
									'fn(v1: +THREE.Vector3, v2: +THREE.Vector3, alpha: number) -> +THREE.Vector3',
								'!doc': 'Sets this vector to be the vector linearly interpolated between *v1* and *v2* with *alpha* factor.',
							},
							angleTo: {
								'!type': 'fn(v: +THREE.Vector3) -> number',
							...
							setFromMatrixColumn: {
								'!type':
									'fn(index: number, matrix: +THREE.Matrix4) -> +THREE.Vector3',
					...
					Vector4: {
						...
						prototype: {
							...
							set: {
								'!type':
									'fn(x: number, y: number, z: number, w: number) -> +THREE.Vector4',
								'!doc': 'Sets value of this vector.',
							},
							copy: {
							...
							addVectors: {
								'!type':
									'fn(a: +THREE.Vector4, b: +THREE.Vector4) -> +THREE.Vector4',
								'!doc': 'Sets this vector to *a + b*.',
							},
							sub: {
								'!type': 'fn(v: +THREE.Vector4) -> +THREE.Vector4',
							...
							lerpVectors: {
								'!type':
									'fn(v1: +THREE.Vector4, v2: +THREE.Vector4, alpha: number) -> +THREE.Vector4',
								'!doc': 'Sets this vector to be the vector linearly interpolated between *v1* and *v2* with *alpha* factor.',
							},
							clone: {
								'!type': 'fn() -> +THREE.Vector4',
							...
							clamp: {
								'!type':
									'fn(min: +THREE.Vector4, max: +THREE.Vector4) -> +THREE.Vector4',
					...
					Bone: {
						...
						prototype: {
							...
							update: {
								'!type':
									'fn(parentSkinMatrix: +THREE.Matrix4, forceUpdate: boolean) -> todo',
					...
					Line: {
						...
						'!type':
							'fn(geometry: +THREE.Geometry, material: +THREE.Material, type: number)',
					},
					Mesh: {
					...
					SkinnedMesh: {
						...
						'!type':
							'fn(geometry: +THREE.Geometry, material: +THREE.Material, useVertexTexture: boolean)',
					},
					Sprite: {
					...
					WebGLRenderer: {
						...
						prototype: {
							...
							renderBufferImmediate: {
								'!type':
									'fn(object: +THREE.Object3D, program: shaderprogram, shading: +THREE.Material)',
								'!doc': 'Render an immediate buffer. Gets called by renderImmediateObject.',
							},
							renderBufferDirect: {
								'!type':
									'fn(camera: +THREE.Camera, lights: [], fog: +THREE.Fog, material: +THREE.Material, geometryGroup: object, object: +THREE.Object3D)',
							...
							render: {
								'!type':
									'fn(scene: +THREE.Scene, camera: +THREE.Camera, renderTarget: +THREE.WebGLRenderTarget, forceClear: bool)',
							...
							setBlending: {
								'!type':
									'fn(blending: number, blendEquation: number, blendSrc: number, blendDst: number)',
							...
							clearTarget: {
								'!type':
									'fn(renderTarget: +THREE.WebGLRenderTarget, color: boolean, depth: boolean, stencil: boolean)',
					...
					WebGLProgram: {
						...
						'!type':
							'fn(renderer: +THREE.WebGLRenderer, code: object, material: +THREE.Material, parameters: object)',
					},
					WebGLShader: {
					...
					CompressedTexture: {
						...
						'!type':
							'fn(mipmaps: [], width: number, height: number, format: number, type: number, mapping: number, wrapS: number, wrapT: number, magFilter: number, minFilter: number, anisotropy: number)',
					},
					DataTexture: {
						...
						'!type':
							'fn(data: ArraybufferView, width: number, height: number, format: number, type: number, mapping: number, wrapS: number, wrapT: number, magFilter: number, minFilter: number, anisotropy: number)',
					},
					Texture: {
						...
						'!type':
							'fn(image, mapping, wrapS, wrapT, magFilter, minFilter, format, type, anisotropy)',
					},
				},
			},
		};
