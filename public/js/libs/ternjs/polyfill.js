	...
	if (!window.JSON)
		(function () {
			var e = void 0,
				...
				m,
				n,
				p = 'function' === typeof define && define.c,
				q = !p && 'object' == typeof exports && exports;
			q || p
				? 'object' == typeof JSON && JSON
					? p
						? (q = JSON)
						: ((q.stringify = JSON.stringify), (q.parse = JSON.parse))
					: p && (q = this.JSON = {})
				: (q = this.JSON || (this.JSON = {}));
			var r,
				t,
				u,
				x,
				...
				H,
				I,
				J = new Date(-3509827334573292),
				K,
				O,
				P;
			try {
				J =
					-109252 == J.getUTCFullYear() &&
					0 === J.getUTCMonth() &&
					1 == J.getUTCDate() &&
					10 == J.getUTCHours() &&
					37 == J.getUTCMinutes() &&
					6 == J.getUTCSeconds() &&
					708 == J.getUTCMilliseconds();
			} catch (Q) {}
			function R(b) {
				var c,
					a,
					...
					if (b == 'json-stringify' || j) {
						if ((c = typeof q.stringify == 'function' && J)) {
							...
							try {
								c =
									q.stringify(0) === '0' &&
									q.stringify(new Number()) === '0' &&
									q.stringify(new String()) == '""' &&
									q.stringify(l) === e &&
									q.stringify(e) === e &&
									q.stringify() === e &&
									q.stringify(d) === '1' &&
									...
									q.stringify([e]) == '[null]' &&
									q.stringify(k) == 'null' &&
									q.stringify([e, l, k]) == '[null,null,null]' &&
									q.stringify({
										A: [d, i, false, k, '\x00\u0008\n\u000c\r\t'],
									}) == '{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}' &&
									q.stringify(k, d) === '1' &&
									q.stringify([1, 2], k, 1) == '[\n 1,\n 2\n]' &&
									q.stringify(new Date(-864e13)) ==
										'"-271821-04-20T00:00:00.000Z"' &&
									q.stringify(new Date(864e13)) ==
										'"+275760-09-13T00:00:00.000Z"' &&
									q.stringify(new Date(-621987552e5)) ==
										'"-000001-01-01T00:00:00.000Z"' &&
									q.stringify(new Date(-1)) == '"1969-12-31T23:59:59.999Z"';
							} catch (f) {
								c = false;
							}
						}
			...
			if (!R('json')) {
				...
				if (!(m = {}.hasOwnProperty))
					m = function (b) {
						var c = {},
							a;
						if (((c.__proto__ = k), (c.__proto__ = { toString: 1 }), c).toString != l)
							m = function (a) {
						...
						for (var c = '"', a = 0, d; (d = b.charAt(a)); a++)
							c =
								...
								('\\"\u0008\u000c\n\r\t'.indexOf(d) > -1
									...
									: (r[d] =
											d < ' '
												? '\\u00' + t(2, d.charCodeAt(0).toString(16))
												: d));
						return c + '"';
					}),
						...
						if (typeof c == 'function' || (typeof c == 'object' && c))
							if (l.call(c) == '[object Function]') j = c;
								...
								for (
									...
									o < g;
									h = c[o++],
										(l.call(h) == '[object String]' ||
											l.call(h) == '[object Number]') &&
											(f[h] = 1)
								);
							}
						if (a)
							if (l.call(a) == '[object Number]') {
								...
								l.call(a) == '[object String]' &&
									(d = a.length <= 10 ? a : a.slice(0, 10));
				...
				R('json-parse') ||
							...
							if ('\t\r\n '.indexOf(a) > -1) H++;
								...
								if (a == '"') {
									...
									if (a >= '0' && a <= '9') {
										for (
											a == '0' &&
											((a = b.charAt(H + 1)), a >= '0' && a <= '9') &&
											C();
											H < c && ((a = b.charAt(H)), a >= '0' && a <= '9');
											H++
										);
										if (b.charAt(H) == '.') {
											for (
												f = ++H;
												f < c && ((a = b.charAt(f)), a >= '0' && a <= '9');
												f++
											);
											f == H && C();
											H = f;
					...
					(F = function (b, c, a) {
						...
						if (typeof d == 'object' && d)
							if (l.call(d) == '[object Array]') for (j = d.length; j--; ) G(d, j, a);
							else
								n(d, function (b) {
									G(d, b, a);
								});
					...
					(q.parse = function (b, c) {
						...
						D() != '$' && C();
						H = I = k;
						return c && l.call(c) == '[object Function]'
							? F(((d = {}), (d[''] = a), d), '', c)
							: a;
					}));
			}
